...
public class CoreCharacterEditStressFragment extends CoreCharacterEditAbstractFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		((ListView) rootView.findViewById(R.id.physical_stress_list)).setAdapter(physicalStressListAdapter);
		...
		((ListView) rootView.findViewById(R.id.mental_stress_list)).setAdapter(mentalStressListAdapter);
